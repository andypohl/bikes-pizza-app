...
export const FEEDS: { value: string; label: string; noun: string; submissions: boolean; layout: string; postingHours: number[] }[] = [
  {
    "value": "bikes",
    "label": "Bikes",
    "noun": "bike",
...
export const GALLERY_FEEDS: string[] = ["bikes","pizza"];

/** Feeds read as full articles. */

export const ARTICLE_FEEDS: string[] = ["news"];

/** Feeds that accept member submissions, with the noun for messages. */

export const SUBMISSION_FEEDS: Record<string, { noun: string }> = {
  "bikes": {"noun":"bike"},
  "pizza": {"noun":"pizza"},
};
...
export const POSTING_HOURS: Record<string, number[]> = {
  "bikes": [8,12,16,20],
  "pizza": [9,13,17,21],
};
...
export const POST_PATHS: Record<string, string> = {
  "news": "/news/{slug}/",
  "default": "/post/{slug}/",
};
...
export function postPath(feed: string, slug: string): string {
...
export type ReactionPalette = { key: string; prompt: string; pick: "one" | "many"; options: Option[] };
...
export const NOTIFICATIONS: NotificationRules = {
  "categories": [
    {
      "value": "newPosts",
      "title": "New posts",
...
export const MEMBERS: MemberRules = {
