...
every size the platforms need:
  ...
  site/public/logo.png, web/*/logo.png       the logo in the website's header
                                             and on the account, review and
                                             admin pages
...
def main(font_path):
    ...
    for site in ("site/public", "web/public", "web/review", "web/admin"):
        save(fit_width(logo, 512), ROOT / site / "logo.png")
